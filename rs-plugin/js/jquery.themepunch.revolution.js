...
(function($,undefined){
	...
	$.fn.extend({
		...
		function swapSlide(container,opt) {
																				...
																				if (nextli.data('transition')=="slidedown") nexttrans = 14
																						...
																						if (nextli.data('transition')=="slideright") nexttrans = 15;
																						     ...
																						     if (nextli.data('transition')=="papercut") nexttrans = 16;
																								    ...
																								    nexttrans=Math.round(Math.random()*17);
			...
			if (opt.ie && (nexttrans==16 || nexttrans==2 || nexttrans==3 || nexttrans==9 || nexttrans==10 || nexttrans==11)) nexttrans=Math.round(Math.random()*3+12);
			...
			container.trigger('revolution.slide.onvideostop');
				...
				function animateTheCaptions(nextli, opt,actli) {
						...
						nextli.find('.caption').each(function(i) {
								...
								if (nextcaption.hasClass("randomrotate") && opt.ie) nextcaption.removeClass("randomrotate").addClass("fade");
